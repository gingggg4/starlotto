...

{
  ...
  "luckyNumber": 오늘의 행운 숫자 (1~45 사이 정수 1개),
  "luckyColor": "행운의 색깔 이름 (한국어, 예: 보라색)",
  "luckyColorHex": "#RRGGBB 형식의 색상 코드",
  "luckyPlace": "로또 사기 좋은 명당 (한국어, 10자 이내, 예: 편의점, 단골 카페, 동네 마트)",
  "luckyTime": "로또 사기 좋은 황금 타임 (오늘 안의 시간대, 예: 오후 2~4시, 저녁 7~9시)",
  "lottoNumbers": [
    [로또 1세트: 1~45 사이 숫자 6개, 중복 없음, 오름차순, 반드시 luckyNumber 포함],
    [로또 2세트: 1~45 사이 숫자 6개, 중복 없음, 오름차순, 반드시 luckyNumber 포함],
    [로또 3세트: 1~45 사이 숫자 6개, 중복 없음, 오름차순, 반드시 luckyNumber 포함],
    [로또 4세트: 1~45 사이 숫자 6개, 중복 없음, 오름차순, 반드시 luckyNumber 포함],
    [로또 5세트: 1~45 사이 숫자 6개, 중복 없음, 오름차순, 반드시 luckyNumber 포함]
  ]
}`;
