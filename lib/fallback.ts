...
const PLACES: string[] = [
  '편의점', '단골 카페', '동네 마트', '대형마트',
  '지하철역 매점', '시장 입구', '백화점 1층', '터미널 매점',
  '회사 근처 가게', '학교 앞 가게', '우체국 옆', '은행 옆 가게',
  '대로변 가게', '골목 안 가게', '햇살 드는 가게', '오래된 가게',
  '새로 생긴 가게', '줄 서는 가게', '단골 슈퍼', '동네 빵집',
  '분주한 사거리', '한적한 가게', '아파트 상가', '동네 슈퍼',
];
